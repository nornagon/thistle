...
(function() {
  var HSLCircle, Picker, cssColorToRGB, fmod, hslToCSS, hslToRGB, hueToRGB, map, normalizeColor, rgbToHSL, style,
    __slice = [].slice;
  ...
  Picker = (function() {
    ...
    Picker.prototype.on = function(e, l) {
      ...
      return ((_ref1 = (_base = this._listeners)[e]) != null ? _ref1 : _base[e] = []).push(l);
    };
